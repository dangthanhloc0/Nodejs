...
import { getAllTourMethod, createTourMethod,createDetailTourMethod,getAllDetailTourMethod,getListToursController  } from '../controllers/TourController/tourController.js';
...
router.get('/getall_tours', getListToursController);
